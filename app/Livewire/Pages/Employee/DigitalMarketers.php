...
class DigitalMarketers extends Component
{
    ...
    {
        return view('livewire.pages.employee.digital-marketers', [
            'branches' => $this->branches,
            'users' => $this->users,
            'employees' => Employee::with('user', 'branch')->where('department', 'digital marketing')->get(),
        ]);
    }
}