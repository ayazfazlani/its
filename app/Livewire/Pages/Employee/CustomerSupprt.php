...
class CustomerSupprt extends Component
{
    ...
    {
        return view('livewire.pages.employee.customer-supprt', [
            'branches' => $this->branches,
            'users' => $this->users,
            'employees' => Employee::with('user', 'branch')->where('department', 'customer support')->get(),
        ]);
    }
}