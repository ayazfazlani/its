<div class="p-6 max-w-xl mx-auto">
    <h1 class="text-2xl font-bold mb-4">Record Finished Goods</h1>
    @if (session('message'))
    ...
    <form wire:submit.prevent="save" class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" wire:model="quantity" class="input input-bordered w-full" min="0.01"
        ...
        <div class="flex gap-2">
            <button type="submit" class="btn btn-primary">Record Finished Goods</button>
