<div wire:ignore.self>
    <section class="w-full p-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold">Delivered Websites</h1>
                <p class="text-gray-500">Manage and track delivered web development projects.</p>
            </div>
                ...
                <tbody>
                    @foreach ($websites as $website)
                        <tr>
                            ...
                            <td>
                                @php
                                    $badgeClass = match ($website->status) {
                                        'delayed' => 'badge-error',
