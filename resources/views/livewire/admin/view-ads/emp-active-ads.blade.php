        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold">
                    @switch($filterStatus)
                        @case('active')
                            ...
                            @break
                        @case('pause')
                            Paused Advertisements
                            @break
                        @case('inActive')
                            Overdue Advertisements
                            @break
                        @case('clientLeft')
                            Client Left Advertisements
                            @break
                        @default
                            Advertisements
                    @endswitch
                ...
                <p class="text-gray-500">
                    @switch($filterStatus)
                        @case('active')
                            Manage and track active advertisements.
                            @break
                        @case('pause')
                            View and manage paused advertisements.
                            @break
                        @case('inActive')
                            View and manage overdue advertisements.
                            @break
                        @case('clientLeft')
                            View and manage client left advertisements.
                            @break
                        @default
